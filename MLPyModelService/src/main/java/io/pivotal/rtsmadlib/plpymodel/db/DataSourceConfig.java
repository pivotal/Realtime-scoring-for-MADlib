...
package io.pivotal.rtsmadlib.plpymodel.db;
...
public class DataSourceConfig {
	...
	NamedParameterJdbcTemplate modeldbNPJdbcTemplate(@Qualifier("modeldb-datasource")DataSource modeldbDataSource) {
	...
	NamedParameterJdbcTemplate containerdbNPJdbcTemplate(@Qualifier("containerdb-datasource")DataSource containerdbDataSource) {
		return new NamedParameterJdbcTemplate(containerdbDataSource);
	}
}
