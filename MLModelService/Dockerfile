...
ADD ./target/MLModelService-1.0.0-SNAPSHOT.jar /opt/pivotal/rts-for-madlib/MLModelService-1.0.0-SNAPSHOT.jar
RUN chmod ugo+rx /opt/pivotal/rts-for-madlib/MLModelService-1.0.0-SNAPSHOT.jar
