...
public class SourceDatabaseRepository {
	...
	public List<Map<String, Object>> fetchFeatures(String schemaName, String featureTableName,
	...
	public int runFeatureGeneration(String schemaName, String functionName, Map<String, Object> parameters) {
	...
	public int runFeatureGeneration(String schemaName, String functionName) {
