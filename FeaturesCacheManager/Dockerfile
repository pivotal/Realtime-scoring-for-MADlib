...
ADD ./target/FeaturesCacheManager-1.0.0-SNAPSHOT.jar /opt/pivotal/rts-for-madlib/FeaturesCacheManager-1.0.0-SNAPSHOT.jar
RUN chmod ugo+rx /opt/pivotal/rts-for-madlib/FeaturesCacheManager-1.0.0-SNAPSHOT.jar
